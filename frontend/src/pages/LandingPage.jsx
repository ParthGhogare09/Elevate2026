...
const LandingPage = () => {
  ...
  const defaultWorkshops = [
    ...
    { id: 'cyber-security', title: 'Cyber Security & Ethical Hacking', shortDescription: 'Learn basic security auditing, ethical hacking methodologies, scanning networks, identifying vulnerabilities, and securing web applications.', description: 'Dive deep into the fundamentals of ethical hacking and cybersecurity. Learn how to scan networks, detect system vulnerabilities, analyze packets, understand basic cryptography, prevent security threats (OWASP Top 10), and implement defensive security measures to safeguard systems and applications.', mentor: 'Dr. Amit Sen', dateTime: 'July 20, 2026 - 05:00 PM IST', status: 'Open' },
